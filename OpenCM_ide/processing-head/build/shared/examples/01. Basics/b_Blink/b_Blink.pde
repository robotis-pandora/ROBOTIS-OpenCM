/*
 ...
 The main difference is that OpenCM9.04 has built-in LED as PWM enable pin.
 
 OpenCM serise board has built-in LED as current sink circuit,
 so, If you want to turn on LED, set BOARD_LED_PIN as LOW
 If you want to turn off LED, set BOARD_LED_PIN as HIGH
