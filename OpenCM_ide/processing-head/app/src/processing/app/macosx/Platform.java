...
//[ROBOTIS]2012-12-18 change setting folder to our own folder "ROBOTIS"
  public File getSettingsFolder() throws Exception {
    return new File(getLibraryFolder(), "ROBOTIS");//new File(getLibraryFolder(), "Arduino");
  }

//[ROBOTIS]2012-12-18 change sketchbook folder to our own folder "ROBOTIS"
  public File getDefaultSketchbookFolder() throws Exception {
    return new File(getDocumentsFolder(), "ROBOTIS");//new File(getDocumentsFolder(), "Arduino");
    /*
