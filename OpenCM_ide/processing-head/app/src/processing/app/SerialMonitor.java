...
public class SerialMonitor extends JFrame implements MessageConsumer {
  ...
  boolean isInUseSerialMonitor = false; //[ROBOTIS] add to disable serial monitor when start download
  ...
  public void openSerialPort() throws SerialException {
    ...
    isInUseSerialMonitor = true; //[ROBOTIS][CHANGE]
    serial.pandoraBoard = false;//[ROBOTIS][CHANGE]
  }
  ...
  public void closeSerialPort() {
    if (serial != null) {
      ...
      isInUseSerialMonitor = false;//[ROBOTIS][CHANGE] 
      serial.pandoraBoard = true; //[ROBOTIS][CHANGE]
