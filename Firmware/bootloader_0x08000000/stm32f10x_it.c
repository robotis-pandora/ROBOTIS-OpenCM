...
void USART2_IRQHandler(void)
{
	...
	sr = USART2->SR;
	/*TxDString("gwUSARTWritePtr=");TxDHex16(gwUSARTWritePtr);TxDString(" "); TxDByte(gwpUSARTBuffer[gwUSARTWritePtr-1]);
	TxDString("\r\n");*/
...
{
	//move to USART2_IRQHandler() @new CM-900 for downloading 2012-07-24
}
